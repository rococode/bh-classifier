...
for i in range(num_total - num_hockey):
    chosen_baseball.append(sys.argv[i + 5 + num_hockey])
    print("appended b", sys.argv[i + 5 + num_hockey], file=sys.stderr)

print("len hockey", len(chosen_hockey))
print("len baseball", len(chosen_baseball))
...
# run_feature.py is called by the feature feedback incorporater class (explanationstudy)
